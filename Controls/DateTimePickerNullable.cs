...
namespace Controls
{
    ...
    public class DateTimePickerNullable : System.Windows.Forms.DateTimePicker
    {
        ...
        private bool vIsNull;

        // If _isNull = true, this value is shown in the DTP
        private string vNullValue;

        // The format of the DateTimePicker control
        private DateTimePickerFormat vFormat = DateTimePickerFormat.Long;

        // The format of the DateTimePicker control as string
        private string vFormatAsString;
        #endregion
        ...
        {
            get { return vNullValue; }
            set { vNullValue = value; }
        }
        #endregion
        ...
        {
            get { return vFormatAsString; }
            set
            {
                vFormatAsString = value;
        ...
        {
            vIsNull = true;
            base.CustomFormat = string.IsNullOrEmpty(vNullValue) ? " " : "'" + vNullValue + "'";
        }
        ...
        protected override void OnCloseUp(EventArgs e)
        {
            if (vIsNull)
            {
                // *** Canvio l'if perque al seleccionar el dia d'avui quan la data és null el botó que arriba és: MouseButtons.Left
